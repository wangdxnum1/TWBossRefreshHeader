...
@implementation TWBossRefreshHeader
...
- (void)setPullingPercent:(CGFloat)pullingPercent
{
    ...
    if ((self.state != MJRefreshStateIdle && self.state != MJRefreshStatePulling)|| images.count == 0) return;
    // 停止动画
